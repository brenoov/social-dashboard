...
function promptModelo(fmt, light) {
  ...
  const pos = FMTGEN[fmt].layout === 'bottom'
    ? 'Place the woman in the LOWER part of the frame so the UPPER ~50% is COMPLETELY EMPTY background for text. Her body may bleed off the bottom and side edges.'
