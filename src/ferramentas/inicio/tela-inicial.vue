  ...
  <div class="tela-inicio">
    ...
    <div class="home-main">
      ...
      <div class="home-cards" :class="{ 'view-list': visualizacao === 'list' }" id="home-cards">
        ...
        <!-- Dashboard Redes Sociais: rota ainda não existe. -->
        <div class="home-card" id="home-card-social" @click="aindaNaoMigrada('Dashboard Redes Sociais')" @mouseenter="definirTemaFundo('social')" @mouseleave="definirTemaFundo('default')">
          <div class="home-card-icon">
        ...
        <div class="home-card" id="home-card-banco" @click="aindaNaoMigrada('Banco de Arquivos')">
