...
.tela-menu-meta-ads .smenu-headline h2{font-family:'Oswald',sans-serif;font-size:26px;font-weight:500;letter-spacing:3px;text-transform:uppercase;color:var(--text);margin-bottom:6px;}
.tela-menu-meta-ads .smenu-headline p{font-family:'IBM Plex Sans',sans-serif;font-size:12px;color:var(--muted);}
...
.tela-menu-meta-ads .smenu-card-num{font-family:'IBM Plex Sans',sans-serif;font-size:10px;letter-spacing:3px;color:var(--muted);text-transform:uppercase;font-weight:600;}
...
.tela-menu-meta-ads .smenu-card-title{font-family:'Oswald',sans-serif;font-size:18px;font-weight:500;letter-spacing:1.5px;text-transform:uppercase;color:var(--text);line-height:1.2;}
.tela-menu-meta-ads .smenu-card-desc{font-family:'IBM Plex Sans',sans-serif;font-size:11px;color:var(--muted);line-height:1.7;}
