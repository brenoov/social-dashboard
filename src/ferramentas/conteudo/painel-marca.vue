<template>
  <!-- O QUE A IA SABE SOBRE ESTA MARCA.
       As duas coisas que o robô de pauta não tem como adivinhar: como a marca
       fala, e contra quem ela disputa. O resto do briefing (o que rendeu, o que
  ...
  <div class="ctd-fundo" @click.self="$emit('fechar')">
    <div class="ctd-painel ctd-painel-largo" role="dialog" aria-labelledby="ctd-marca-t">
      <div class="ctd-painel-cab">
        <span id="ctd-marca-t" class="ctd-painel-t">A marca · {{ conta?.name || 'marca' }}</span>
