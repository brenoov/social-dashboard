...
//
// ESTA PASTA NÃO TEM ARQUIVO .js PRÓPRIO — tudo o que a tela usa de fora vem de
// `src/compartilhado/`. Por isso um guarda que só varresse a pasta local seria
// decorativo: passaria sempre, protegendo nada.

const AQUI = dirname(fileURLToPath(import.meta.url))
const COMPARTILHADO = resolve(AQUI, '..', '..', 'compartilhado')
const TELA = 'tela-de-analise-vendas.vue'
...
test('a Análise de Vendas não usa função de módulo sem importar', () => {
...
test('o guarda cobre a pasta compartilhado, de onde a tela puxa a data da venda', () => {
