<template>
  ...
  <div class="tela-redes-sociais">
    ...
    <div class="wrapper">
      ...
      <barra-de-topo voltar="Central" titulo="Análise de Redes Sociais" @voltar="fecharDashboard" />

      <!-- FAIXA DE CONTROLES: periodo, datas e perfis. Nao sao acoes pequenas —
           e uma tira larga que dentro da barra disputava espaco com o titulo. -->
...
.tela-redes-sociais :deep(.custom-date-input){font-family:'IBM Plex Sans',sans-serif;font-weight:400;font-size:10px;padding:4px 7px;border-radius:3px;border:1.5px solid var(--border);background:var(--surface);color:var(--text);outline:none;cursor:pointer;flex-shrink:0;}
